...
function Home() {
    ...
    // get total order price for all items in cart
    const getOrderTotal = () => {
      return cart.reduce((total, cartItem) => total + cartItem.total_price, 0);
    }

    // remove all instances of one item from cart
    ...
    // close popup and clear cart when start new order button is clicked
    const startNewOrderClick = () => {
      togglePopup();
      setCart([]);
    }
    ...
    return (
      <div>
        {/* contains everything found in main page */}
        <div className="outermost-wrapper-container">
          ...
          <div className="title-images-container">
            ...
            {/* grid that food images sit in along with all associated information */}
            <div className="image-grid-container">
                  {data.map((item, index) => (
                      <div key={index} className="image-text-container">
                          ...
                          {/* all information associated with food item */}
          ...
          {/* your cart card that displays all items and associated information found in cart, user also has option to confirm current order */}
          <div className="your-cart-container">
              <div className="your-cart-card-container">
                ...
                {/* display items and assocaited quantities and prices */}
                <div className='your-cart-card-items-container'>
                  ...
                  // if at least one item is found in cart
                  ) : (

                    <div className="cart-items-container">

                      {/* for each item display food item information along with remove item button */}
                      {cart.map((cartItem, index) => (
                        <div key={index} className="cart-item">
                          <div className='cart-item-info-remove-item-container'>

                            <div>
                              {/* food item information including name, quantity, price, and total price */}
                            ...
                            {/* remove item button, if clicked all instances/quantities of this item are removed from cart */}
                      ...
                      {/* button to confirm order and display popup to start new order */}
          ...
          {/* popup shown when user confirms order and given option to start new order */}
          {/* shows all items ordered and associated item information and total order price */}
          ...
          <div className="popup-container">
            <div className='popup-content'>
              ...
              <div className='popup-content-container'>
                ...
                {/* popup header including icon, title, and additional text */}
                ...
                {/* displays all items in submitted order including food image and associated item information */}
                ...
                {/* button to start new order, if clicked then close popup and clear cart for new order */}
                <button className='start-new-order-button' onClick={startNewOrderClick}>
                  Start New Order
                </button>
